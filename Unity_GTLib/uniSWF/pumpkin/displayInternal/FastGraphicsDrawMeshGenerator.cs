namespace pumpkin.displayInternal
{
    ...
    /// <summary>
    /// The fast graphics draw mesh generator class.
    /// </summary>
    public class FastGraphicsDrawMeshGenerator : IGraphicsGenerator
    {
        ...
        private void renderDisplayObjectContainer(DisplayObjectContainer parent, Color pcolor, bool movieClip, int renderQueue)
        {
            if (phaseId == 0)
            {
            ...
            for (int i = 0; i < parent.numChildren; i++)
            {
                if (movieClip)
                {
                    ...
                    if (obj2.visible)
                    {
                        ...
                        renderGraphics(info, obj2, obj2.colorTransform, renderQueue);
                        renderDisplayObjectContainer(obj2, obj2.colorTransform, false, renderQueue);
                    }
                }
                else
                {
                    ...
                    BitmapAssetInfo info = obj2.bmpInfo;
                    renderGraphics(info, obj2, pcolor, renderQueue);
                    renderDisplayObjectContainer(obj2, pcolor, false, renderQueue);
